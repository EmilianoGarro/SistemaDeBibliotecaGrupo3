...
public class VistaAutores extends javax.swing.JInternalFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(jDFechaNac, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jTApellido, javax.swing.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
    ...
    private void habilitarBotonGuardar(){
        ...
        if(!jTNacionalidad.getText().isEmpty()&&!jTDni.getText().isEmpty()&&!jTNombre.getText().isEmpty()&&!jTApellido.getText().isEmpty()&&!jTDni.getText().isEmpty()){
    ...
    private void jBActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBActualizarActionPerformed
        // TODO add your handling code here:
        int id = Integer.parseInt(jTID.getText());
        Autor aux = autorData.buscarAutor(id);
        if(aux!=null){
        String nombre=jTNombre.getText();
        String apellido=jTApellido.getText();
        int dni = Integer.parseInt(jTDni.getText());
