 ...
 * @author Asus
 */
public class ListadoLectores extends javax.swing.JInternalFrame {
    ...
    public void cargaDatos(){
        ...
        switch (opcion) {
            case "activos" : lectores = (ArrayList)lectorData.obtenerLectoresSegunEstado(true); break;
            case "inactivos" : lectores = (ArrayList)lectorData.obtenerLectoresSegunEstado(false); break;
            case "todos" : lectores = (ArrayList)lectorData.obtenerLectores(); break;
        }
 
        for (Lector lector : lectores) {       
            modelo.addRow(new Object[]{lector.getId_Lector(), lector.getDni(), lector.getApellido(), lector.getNombre(), lector.getEmail(), lector.isActivo()});
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        tLectores = new javax.swing.JTable();
        ...
        label1.setText("Listado de Lectores");
        ...
        tLectores.setBackground(new java.awt.Color(255, 255, 204));
        tLectores.setForeground(new java.awt.Color(51, 51, 51));
        tLectores.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tLectores.setToolTipText("");
        jScrollPane1.setViewportView(tLectores);
    ...
    private javax.swing.JTable tLectores;
