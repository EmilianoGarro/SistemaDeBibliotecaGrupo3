...
public class ListadoLibros extends javax.swing.JInternalFrame {
    ...
    public void cargaDatos(){
        ...
        switch (opcion) {
            case "activos" : libros = (ArrayList)libroData.obtenerLibrosSegunEstado(true); break;
            case "inactivos" : libros = (ArrayList)libroData.obtenerLibrosSegunEstado(false); break;
            case "todos" : libros = (ArrayList)libroData.obtenerLibros(); break;
        }
 
        for (Libro libro : libros) {       
            modelo.addRow(new Object[]{libro.getId_Libro(), libro.getAutor(), libro.getISBN(), libro.getNombre(), libro.getTipo(), libro.getEditorial(), libro.getAnio(), libro.isActivo()});
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        label1.setText("Listado de Libros");
        ...
        tLibros.setBackground(new java.awt.Color(255, 255, 204));
        tLibros.setForeground(new java.awt.Color(51, 51, 51));
